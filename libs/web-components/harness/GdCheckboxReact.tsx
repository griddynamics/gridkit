...
/**
 * React consumption harness for `gd-checkbox` — the React-19-scope nuance from CTORNDSD-581's
 * Migration Example applies here: React can assign `checked`/`indeterminate` as JS properties
