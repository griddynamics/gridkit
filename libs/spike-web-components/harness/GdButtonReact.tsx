...
/**
 * React consumption harness per CTORNDSD-581's Scope — proves `gd-button` is usable from React via
 * `@lit/react`'s `createComponent()` (React 18 path). React 19 can also consume `<gd-button>` directly
 * as a native custom element without this wrapper; both paths are named in the spike's Migration Example.
 */
