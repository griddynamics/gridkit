...
_66 components total — generated from `libs/ui/src/ai/schemas/` on 2026-07-20._
...
| Prop          | Type                                                      | Description                                                                                                                                                                                                                                                                                            |
| ------------- | --------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `name`        | `string`                                                  | Real AvatarUser React prop, required. Primary user display name shown next to or below the avatar. When src is omitted, the renderer derives initials from this name for the avatar fallback.                                                                                                          |
| `variant`     | `"card"` \| `"profile"`                                   | Real AvatarUser React prop. Layout variant of the component.                                                                                                                                                                                                                                           |
| `subtitle`    | `string`                                                  | Real AvatarUser React prop. Secondary line of text beneath the name, such as a role, team, or email address.                                                                                                                                                                                           |
| `description` | `string`                                                  | A2UI JSON field only — not a real AvatarUser React prop. Fallback subtitle text used when subtitle is absent — the renderer promotes description into the real subtitle prop automatically.                                                                                                            |
| `src`         | `string`                                                  | Real AvatarUser React prop. URL of the avatar image.                                                                                                                                                                                                                                                   |
| `alt`         | `string`                                                  | Real AvatarUser React prop. Alt text for the avatar image.                                                                                                                                                                                                                                             |
...
| `sizeVariant` | `"xs"` \| `"sm"` \| `"md"` \| `"lg"` \| `"xl"` \| `"xxl"` | Real AvatarUser React prop (AvatarUserProps.sizeVariant). Also accepted as a top-level A2UI field — size is preferred in new A2UI specs.                                                                                                                                                               |
| _...+9 more_  |                                                           |                                                                                                                                                                                                                                                                                                        |
...
| Prop          | Type                                                      | Description                                                                                                                                                                                                                                                                                                                 |
| ------------- | --------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `label`       | `string`                                                  | A2UI JSON field only — not a real Avatar React prop. Initials text shown as fallback (e.g. "JD"). Use label OR value — do NOT use "fallbackComponent" in A2UI JSON. Renderer checks label first, then value, and maps the result into the real fallbackComponent prop.                                                      |
| `value`       | `string`                                                  | A2UI JSON field only — not a real Avatar React prop. Alias for label: initials text shown as avatar fallback when label is absent (e.g. "JD"). The renderer promotes value into the real fallbackComponent prop automatically. Prefer label in new A2UI specs.                                                              |
| `src`         | `string`                                                  | Real Avatar React prop. Image URL. Also a top-level field in A2UI spec.                                                                                                                                                                                                                                                     |
| `alt`         | `string`                                                  | Real Avatar React prop. Image alt text. Also a top-level field in A2UI spec.                                                                                                                                                                                                                                                |
...
| `sizeVariant` | `"xs"` \| `"sm"` \| `"md"` \| `"lg"` \| `"xl"` \| `"xxl"` | Real Avatar React prop (AvatarProps.sizeVariant). Also accepted as a top-level A2UI field — size is preferred in new A2UI specs.                                                                                                                                                                                            |
| `withBadge`   | `boolean`                                                 | Real Avatar React prop. Show status dot badge ON the avatar. Also a top-level A2UI field.                                                                                                                                                                                                                                   |
| `badgeColor`  | `string`                                                  | Real Avatar React prop. Badge background color. Also a top-level A2UI field. Prefer theme color token paths (e.g. "bg.fill.success.primary.default", "bg.fill.error.primary.default"). Use raw CSS/hex only when no theme token fits.                                                                                       |
| _...+6 more_  |                                                           |                                                                                                                                                                                                                                                                                                                             |
