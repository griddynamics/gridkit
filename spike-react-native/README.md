# spike-react-native (CTORNDSD-590)

Disposable React Native (Expo) PoC. See `plans/ctorndsd-590-react-native-integration-spike.md` for the
...
2. **Parallel-safety with CTORNDSD-581.** `spike-web-components` is the one package that touches shared
